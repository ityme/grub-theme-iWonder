...
printf "\n"
read -p "Enter your desired font size [Recommendations: 1K(14-16), 2K(24-28), 4K(36-42)]: " FONT_SIZE 1>&2
printf "\n"
...
tput setaf 3
printf "\n"
echo "Selected font size: $FONT_SIZE" 1>&2
printf "\n"
tput sgr0
mkdir ./$THEME_NAME
grub-mkfont -s $FONT_SIZE -o ./$THEME_NAME/SourGummy-Regular.pf2 ./SourGummy-Regular.ttf
...
cp ./solitary-girl-silhouette.jpg ./$THEME_NAME
cp ./theme.txt ./$THEME_NAME

mv $THEME_NAME $GRUB_DIR/themes
